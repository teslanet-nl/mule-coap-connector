...
public class InternalResponseException extends Exception
{
     ...
     * @param message
     */
    public InternalResponseException( String message )
    {
        super( message );
    }
     ...
     */
    public InternalResponseException( String message, Throwable e )
    {
        super( message, e );
    }
     ...
     * @param e The cause of the exception
     */
    public InternalResponseException( Throwable e )
    {
        super( e );
    }
}
