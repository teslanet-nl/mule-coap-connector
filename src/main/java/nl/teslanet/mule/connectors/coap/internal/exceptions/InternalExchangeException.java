...
public class InternalExchangeException extends Exception
{
     ...
     * @param message
     */
    public InternalExchangeException( String message )
    {
        super( message );
    }
     ...
     */
    public InternalExchangeException( String message, Throwable e )
    {
        super( message, e );
    }
     ...
     * @param e The cause of the exception
     */
    public InternalExchangeException( Throwable e )
    {
        super( e );
    }
}
