...
public class InternalResourceUriException extends Exception
{
     ...
     * @param message
     */
    public InternalResourceUriException( String message )
    {
        super( message );
    }
     ...
     */
    public InternalResourceUriException( String message, Throwable e )
    {
        super( message, e );
    }
     ...
     * @param e The cause of the exception
     */
    public InternalResourceUriException( Throwable e )
    {
        super( e );
    }
