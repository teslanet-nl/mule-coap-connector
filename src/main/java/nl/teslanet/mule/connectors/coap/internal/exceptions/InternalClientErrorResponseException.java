...
public class InternalClientErrorResponseException extends Exception
{
     ...
     * @param message
     */
    public InternalClientErrorResponseException( String message )
    {
        super( message );
    }
     ...
     */
    public InternalClientErrorResponseException( String message, Throwable e )
    {
        super( message, e );
    }
     ...
     * @param e The cause of the exception
     */
    public InternalClientErrorResponseException( Throwable e )
    {
        super( e );
    }
}
