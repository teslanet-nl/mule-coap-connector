 ...
 *
 */
public abstract class AbstractProxyBuilder extends AbstractVirtualHostingBuilder
{
    /**
    ...
    @Optional
    @Expression( ExpressionSupport.SUPPORTED )
    @Placement( order= 122, tab= Placement.ADVANCED_TAB )
    @Summary( "The Proxy host Option is used to make a request to a forward-proxy.\nUse either proxy-scheme or proxy-host and proxy-port." )
    ...
    @Optional
    @Expression( ExpressionSupport.SUPPORTED )
    @Placement( order= 123, tab= Placement.ADVANCED_TAB )
    @Summary( "The Proxy port Option is used to make a request to a forward-proxy.\nUse either proxy-scheme or proxy-host and proxy-port." )
