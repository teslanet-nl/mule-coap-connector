...
public interface ConfigVisitor
{
    ...
    /**
     * Visit IsItUsed configuration object.
     * @param toVisit the object to visit.
     */
     ...
     * @param toVisit the object to visit.
     */
    void visit( TCPClientEndpoint toVisit );

    /**
     * Visit TCPServerEndpoint configuration object.
     * @param toVisit the object to visit.
     */
    void visit( TCPServerEndpoint toVisit );

    /**
     * Visit TLSEndpoint configuration object.
     * @param toVisit the object to visit.
     */
    void visit( TLSEndpoint toVisit );

    /**
     * Visit TLSClientEndpoint configuration object.
     * @param toVisit the object to visit.
     */
    void visit( TLSClientEndpoint toVisit );

    /**
     * Visit TLSServerEndpoint configuration object.
     * @param toVisit the object to visit.
     */
    void visit( TLSServerEndpoint toVisit );
