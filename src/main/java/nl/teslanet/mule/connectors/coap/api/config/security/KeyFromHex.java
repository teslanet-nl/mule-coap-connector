 ...
 *
 */
public class KeyFromHex implements KeyConfig
{
    /**
     * The hexadecimal value from which the key is formed.
     */
    @Parameter
    @Password
    @Expression( ExpressionSupport.NOT_SUPPORTED )
    @ParameterDsl( allowReferences= false )
    @Summary( value= "The hexadecimal value from which the key is formed." )
