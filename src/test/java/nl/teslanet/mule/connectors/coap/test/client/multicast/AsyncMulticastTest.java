...
public class AsyncMulticastTest extends AbstractClientTestCase
{
    ...
    public static Collection< Object[] > data()
    {
        return Arrays
            .asList( new Object [] []
            { { "get_me", Code.GET, "coap://224.0.1.187/basic/get_me", "CONTENT", "GET called on: /basic/get_me"
                .getBytes() },
                { "do_not_get_me", Code.GET, "coap://224.0.1.187/basic/do_not_get_me", null, null },
                { "post_me", Code.POST, "coap://224.0.1.187/basic/post_me", "CREATED", "POST called on: /basic/post_me"
                    .getBytes() },
                { "do_not_post_me", Code.POST, "coap://224.0.1.187/basic/do_not_post_me", null, null },
                { "put_me", Code.PUT, "coap://224.0.1.187/basic/put_me", "CHANGED", "PUT called on: /basic/put_me"
                    .getBytes() },
                { "do_not_put_me", Code.PUT, "coap://224.0.1.187/basic/do_not_put_me", null, null },
                { "delete_me", Code.DELETE, "coap://224.0.1.187/basic/delete_me", "DELETED",
