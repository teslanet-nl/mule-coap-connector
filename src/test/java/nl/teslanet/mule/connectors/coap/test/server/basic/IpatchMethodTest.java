...
/**
 * Ipatch method basic tests
 *
 */
public class IpatchMethodTest extends AbstractServerTestCase
{
    @Override
    ...
    {
        String uri= "coap://localhost/basic/ipatch_me";
        setClientUri( uri );

        CoapResponse response= client.advanced( new Request( Code.IPATCH ) );
    ...
    @Test
    public void testNoIpatchAllowed() throws ConnectorException, IOException
    {
        String uri= "coap://localhost/basic/do_not_ipatch_me";

        setClientUri( uri );

        CoapResponse response= client.advanced( new Request( Code.IPATCH ) );

        assertNotNull( "ipatch gave no response", response );
    ...
    @Test
    public void testNoIpatchAllowed2() throws ConnectorException, IOException
    {
        String uri= "coap://localhost/basic/do_not_ipatch_me2";
    ...
    {
        String uri= "coap://localhost/basic/do_not_ipatch_me3";
