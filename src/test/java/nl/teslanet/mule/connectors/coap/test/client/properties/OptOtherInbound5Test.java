 ...
 *
 */
public class OptOtherInbound5Test extends AbstractOtherOptionInboundPropertyTestCase
{
    ...
    {
        return attributes.getResponseOptionAttributes().getOtherOptions().get( 65010 );
    }
}
