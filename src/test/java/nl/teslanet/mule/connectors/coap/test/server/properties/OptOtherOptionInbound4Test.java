 ...
 *
 */
public class OptOtherOptionInbound4Test extends AbstractInboundPropertyTestcase
{
    ...
    {
        return "mule-server-config/properties/testserver-options-other65009-inbound2.xml";
    };
}
