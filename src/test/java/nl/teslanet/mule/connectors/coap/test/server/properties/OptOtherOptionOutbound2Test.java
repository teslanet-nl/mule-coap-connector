 ...
 *
 */
public class OptOtherOptionOutbound2Test extends AbstractOutboundPropertyTestcase
{
    ...
    {
        return "mule-server-config/properties/testserver-options-other65013-outbound.xml";
    }
}
