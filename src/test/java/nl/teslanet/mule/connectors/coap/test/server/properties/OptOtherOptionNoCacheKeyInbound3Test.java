...
public class OptOtherOptionNoCacheKeyInbound3Test extends AbstractInboundPropertyTestcase
{
    ...
    {
        return "coap.opt.other.65012.no_cache_key";
    }
    ...
    {
        return "mule-server-config/properties/testserver-options-other65012-nocachekey-inbound.xml";
    };
}
