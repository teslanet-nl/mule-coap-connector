 ...
 *
 */
public class OptOtherOptionInbound6Test extends AbstractInboundPropertyTestcase
{
    ...
    {
        return "mule-server-config/properties/testserver-options-other65010-inbound2.xml";
    };
}
