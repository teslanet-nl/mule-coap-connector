 ...
 *
 */
public class OptOtherInbound3NoCacheKeyTest extends AbstractOtherOptionInboundPropertyNoCacheKeyTestCase
{
    byte[][] values= { { (byte) 0x12, (byte) 0x23, (byte) 0x45, (byte) 0x22 } };
