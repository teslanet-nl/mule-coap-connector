 ...
 *
 */
public class OptOtherInbound3Test extends AbstractOtherOptionInboundPropertyTestCase
{
    ...
    {
        return attributes.getResponseOptionAttributes().getOtherOptions().get( 65308 );
    }
}
