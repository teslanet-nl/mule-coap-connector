 ...
 *
 */
public class OptOtherOptionInbound5Test extends AbstractInboundPropertyTestcase
{
    ...
    {
        return "mule-server-config/properties/testserver-options-other65010-inbound.xml";
    };
}
