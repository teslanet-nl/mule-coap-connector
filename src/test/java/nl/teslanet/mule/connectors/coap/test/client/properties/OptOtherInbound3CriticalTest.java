 ...
 *
 */
public class OptOtherInbound3CriticalTest extends AbstractOtherOptionInboundPropertyCriticalTestCase
{
    byte[][] values= { { (byte) 0x12, (byte) 0x23, (byte) 0x45, (byte) 0x11 } };
