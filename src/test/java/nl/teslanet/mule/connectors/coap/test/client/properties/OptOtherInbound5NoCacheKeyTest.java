 ...
 *
 */
public class OptOtherInbound5NoCacheKeyTest extends AbstractOtherOptionInboundPropertyNoCacheKeyTestCase
{
    byte[][] values= { { (byte) 0x12, (byte) 0x99, (byte) 0x45, (byte) 0x22 } };
