        ...
        switch ( param )
        {
            ...
            case ENDPOINT_BINDTOPORT:
                return new ConfigDescription(
                    ...
                    "9983",
                    "9983",
                    ConfigDescription.TEST_UDP | ConfigDescription.TEST_MULTICAST | ConfigDescription.TEST_DTLS
                );
            ...
            case ENDPOINT_UDP_MULTICAST_RECEIVERS:
                return new ConfigDescription(
                    ...
                    "",
                    "",
                    "7777,224.0.1.187,eth0;8888,[ff02::fd];9999,[ff05::fd],lo;",
                    null,
                    ConfigDescription.TEST_UDP
                );
            case maxActivePeers:
            ...
            case maxServerResponseDelay:
                return new ConfigDescription(
                    ...
                    "555s",
                    "555[s]",
                    ConfigDescription.TEST_MULTICAST | ConfigDescription.TEST_DTLS
                );
            ...
            case UDP_RECEIVER_THREAD_COUNT:
                return new ConfigDescription(
                    ...
                    "12",
                    "12",
                    ConfigDescription.TEST_UDP | ConfigDescription.TEST_MULTICAST
                );
            ...
            case multicastGroups:
                return new ConfigDescription(
                    ...
                    "",
                    "",
                    "224.0.1.187;test,eth0;",
                    "224.0.1.187;test,eth0;",
                    ConfigDescription.TEST_MULTICAST
                );
