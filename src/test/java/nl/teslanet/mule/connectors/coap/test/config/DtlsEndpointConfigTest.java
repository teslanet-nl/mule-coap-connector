...
public class DtlsEndpointConfigTest
{
    /**
    ...
    public void testGetterAndSetter() throws Exception
    {
        ...
        DTLSEndpoint config= new DTLSEndpoint( "testEndpoint" );
    ...
    {
        return !ConfigParams.getConfigDescription( param ).isRelevant( ConfigDescription.TEST_DTLS );
    }
